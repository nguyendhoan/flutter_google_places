...
class PlacesAutocompleteWidget extends StatefulWidget {
  ...
  final String startTextSearch;
  final String endTextSearch;
  final String hint;
  ...
  void _onQueryChange() {
    ...
    _debounce = Timer(Duration(milliseconds: widget.debounce), () {
      if (!_queryBehavior.isClosed) {
        _queryBehavior.add(widget.startTextSearch +
            _queryTextController.text +
            widget.endTextSearch);
      }
    });
  }
...
class PlacesAutocomplete {
  static Future<Prediction> show(
      ...
      Client httpClient,
      String startText = "",
      String startTextSearch = "",
      String endTextSearch = ""}) {
